...
// maximum sum. If there are multiple maxima, then get the last one.
...
// DOM-dependent search setup — skipped in Node.js test environment
(function () {
...
// Export pure functions for testing (Node.js / CommonJS)
if (typeof module !== 'undefined') {
  module.exports = { makeTeaser, substringByByte, getByteByBinary, getByteByHex };
}
